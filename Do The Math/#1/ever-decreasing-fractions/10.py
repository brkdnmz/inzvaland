...
def solve(t=1):
    ...
    for _ in range(t):
        # numbers having max div cnts: [720720, 831600, 997920]
        max_div_cnts = [720720, 831600, 997920]
        diff = max_div_cnts[randint(0, 2)]
        b = 1
        a = b + diff
        print(a-b)
        cnt = 0
...
os.system(f"zip -r \"10. a-b max divisor cnt {N_TC}.zip\" input output")
os.system(f"copy gen.py 10.py")
