...
def gen_range(
    lower: int, upper: int, min_length: int = 1, max_length: Union[int, None] = None
) -> Tuple[int, int]:
    total_length = upper - lower + 1
    ...
    ), f"Invalid arguments: min_length={min_length} max_length={max_length}"

    length = randint(min_length, max_length)
    l = randint(lower, upper - length + 1)
